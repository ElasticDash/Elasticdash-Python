...
def get_api():
    ...
    return FernElasticDash(
        username=os.environ.get("ELASTICDASH_PUBLIC_KEY"),
        password=os.environ.get("ELASTICDASH_SECRET_KEY"),
        base_url=os.environ.get("ELASTICDASH_BASE_URL"),
    )
